...
/**
 * Configuration with default values set. It is recommended to use this as a
 * base class for any other configuration.
 * 
 * @author Johan
 *
 */
public class DefaultConfiguration implements Configuration {
    ...
    public String toString() {
        return "DefaultConfiguration [hostname=" + hostname + ", restBaseUrl="
                ...
                + ", authenticationPassword=***" + ", entityParserFactory="
                + entityParserFactory + ", failOnUnknownProperties="
